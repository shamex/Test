 ...
 */
@Entity
@Table(name = "treatment", catalog = "feobet", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Treatment.findByCreatedate", query = "SELECT t FROM Treatment t WHERE t.createdate = :createdate"),
    @NamedQuery(name = "Treatment.findByUpdatedate", query = "SELECT t FROM Treatment t WHERE t.updatedate = :updatedate"),
    @NamedQuery(name = "Treatment.findByDeletedate", query = "SELECT t FROM Treatment t WHERE t.deletedate = :deletedate"),
    @NamedQuery(name = "Treatment.findByDisabled", query = "SELECT t FROM Treatment t WHERE t.disabled = :disabled"),
    @NamedQuery(name = "Treatment.findByDeleted", query = "SELECT t FROM Treatment t WHERE t.deleted = :deleted")})
public class Treatment implements Serializable {
    ...
    public String toString() {
        return "com.um.feobet.persistence.entity.Treatment[ id=" + id + " ]";
    }
